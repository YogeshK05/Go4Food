...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="view_order_details.css">
...
<div class="container">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 25px; text-align: center; font-size: 30px;color: black; text-align: center;text-shadow: 2px 2px lightgreen"><u> YOUR FOOD ORDER LIST </u></h3>
