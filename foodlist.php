...
<html>
  ...
  <head>
    <title> Foodlist | GO 4 FOOD </title>
  </head>
...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"><i class="fa fa-cutlery"></i> Food Zone </a></li>
            <li><a href="cart.php"><i class="fa fa-cart-plus"></i> Cart  (<?php
...
<ul class="nav navbar-nav navbar-right">
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-user"></i> Sign Up <span class="caret"></span> </a>
            ...
            <li><a href="#" class="dropdown-toggle active" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><i class="fa fa-sign-in"></i> Login <span class="caret"></span></a>
              <ul class="dropdown-menu">
...
?>
    ...
    <div class="carousel-inner">
      ...
      <div class="item">
      <img src="images/slide2.jpg" style="width:100%; height: 69%">
      <div class="carousel-caption">
    ...
    <br><br>
    <h1 style="color: black; text-align: center;text-shadow: 2px 2px lightgreen">Welcome To GO 4 Food Canteen!</h1> 
    <br><br> 
...
<h5 class="text-danger"><i class="fa fa-inr"></i> <?php echo $row["price"]; ?>/-</h5>
