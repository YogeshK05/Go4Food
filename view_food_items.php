...
<html>
  ...
  <link rel="stylesheet" type = "text/css" href ="view_food_items.css">
...
<div class="container">
    ...
    <div class="col-xs-9">
      <div class="form-area" style="padding: 0px 100px 100px 100px;">
        ...
        <br style="clear: both">
          <h3 style="margin-bottom: 30px; text-align: center; font-size: 30px;color: black; text-align: center;text-shadow: 2px 2px lightgreen"><u>YOUR FOOD ITEMS LIST </u></h3>
...
if (mysqli_num_rows($result) > 0)
{
  ...
  <tbody>
    <tr>
      <td> <i class="fa fa-menu-right"></i> </td>
